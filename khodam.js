...
//list blacklist tambahin sendiri 
const blacklist = ["sugik", "uyung", "eko", "kontol"];
...
document.getElementById('checkButton').addEventListener('click', function() {
    ...
    if (name) {
        if (blacklist.includes(name.toLowerCase())) {
            result.innerHTML = "<span style='color: red;'>Kamu masuk daftar hitam cek daftar hitam <a href='blacklist.html'>disini</a></span>";
        } else {
